# Contributing to conda-tasks

Thank you for your interest in improving conda-tasks! This document describes
...
1. Fork the repository on [GitHub](https://github.com/conda-incubator/conda-tasks).
...
- Tests mirror the source structure (e.g., tests for `conda_tasks/cli/run.py`
  live in `tests/cli/test_run.py`).
...
- Open an [issue](https://github.com/conda-incubator/conda-tasks/issues) for
